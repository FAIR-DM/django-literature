...
described. A checkbox on the form skips the preview for a one-step import instead. Either way
you land on a report: how many entries were created, skipped and failed, and one row per entry in the
